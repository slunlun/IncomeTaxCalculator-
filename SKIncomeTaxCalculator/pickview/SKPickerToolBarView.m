...
@interface SKPickerToolBarView ()

@end

@implementation SKPickerToolBarView
...
- (void)configProprty {
    ...
    [self.rightBtn setTitleColor:[UIColor colorWithRed:0/255.0 green:97.0/255.0 blue:255.0/255.0 alpha:1.0] forState:UIControlStateNormal];

...
@implementation SKBasePickerView
...
- (void)configProprty {
    ...
    // MARK: 内容视图
    self.contentView.backgroundColor = [UIColor colorWithRed:208.0/255.0 green:212.0/255.0 blue:217.0/255.0 alpha:1.0];
...
- (SKPickerToolBarView *)toolBarView {
    if (_toolBarView == nil) {
        _toolBarView = [[SKPickerToolBarView alloc] init];
    }
    return _toolBarView;
}
